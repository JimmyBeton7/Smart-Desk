// src/Pages/TaskListView.jsx
import React, { useState, useEffect } from 'react';
import { Calendar, Trash, Pen } from 'lucide-react';
    ...
    return (
        <div className="todo-container">
            ...
            <div className="todo-input">
                <input value={input} onChange={e => setInput(e.target.value)} placeholder={t('todo.addPlaceholder')} />
                    ...
                    <small className="deadline"><Calendar size={16} style={{ marginRight: 8 }} /> {task.deadline}</small>
                        ...
                        <div className="task-actions">
                            <div className="task-actions-edit">
                                <button onClick={() => editTask(task)}><Pen size={16} /></button>
                            </div>
                            <div className="task-actions-delete">
                                <button onClick={() => removeTask(task.id)}><Trash size={16} /></button>
                            </div>
                        </div>
                    </li>
                ))}
